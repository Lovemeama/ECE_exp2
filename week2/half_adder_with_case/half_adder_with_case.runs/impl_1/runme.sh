...
HD_PWD='C:/git/ECE_exp2/week2/half_adder_with_case/half_adder_with_case.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_with_case.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source half_adder_with_case.tcl -notrace
