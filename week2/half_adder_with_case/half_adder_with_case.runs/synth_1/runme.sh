...
HD_PWD='C:/git/ECE_exp2/week2/half_adder_with_case/half_adder_with_case.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_with_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_adder_with_case.tcl
